...
let CandidatePersonalitiesTestForm = ({
    classes, 
...
CandidatePersonalitiesTestForm = reduxForm({
    form: 'CandidatePersonalitiesTestForm',
    destroyOnUnmount: false,
    forceUnregisterOnUnmount: true,
    enableReinitialize: true,
})(CandidatePersonalitiesTestForm);

export default withStyles(styles)(CandidatePersonalitiesTestForm);